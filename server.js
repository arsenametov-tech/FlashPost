...
const server = http.createServer((req, res) => {
    ...
    if (filePath === './' || filePath === './app') {
        filePath = './app.html';
    } else if (filePath === './index' || filePath === './main') {
        filePath = './index.html';
    }
                    ...
                    <html>
                        ...
                        <body>
                            <div class="container">
                                ...
                                <div class="links">
                                    <a href="/app.html">🚀 Мини-приложение</a>
                                    <a href="/index.html">📱 Основное приложение</a>
                                    <a href="/test-access.html">🔧 Тест доступа</a>
                                </div>
                            </div>
                        </body>
                    </html>
...
server.listen(port, '0.0.0.0', () => {
    console.log(`\n🚀 FlashPost AI сервер успешно запущен!`);
    console.log(`\n📍 АДРЕСА:`);
    console.log(`   • http://localhost:${port} - Локальный доступ`);
    console.log(`   • http://127.0.0.1:${port} - Альтернативный адрес`);
    console.log(`\n📁 ФАЙЛЫ:`);
    console.log(`   • http://localhost:${port}/app.html - Мини-приложение (рекомендуется)`);
    console.log(`   • http://localhost:${port}/index.html - Основное приложение`);
